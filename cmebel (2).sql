...
--
-- Хост: localhost
-- Время создания: Ноя 17 2015 г., 14:14
...
INSERT INTO `orders` (`id`, `order_opencart_id`, `version`, `client_id`, `status_id`, `total`, `date_added`, `date_modified`) VALUES
(5, 1, 1, 1, 1, '1000.98', '2015-11-04 18:32:21', '2015-11-16 16:07:32'),
(6, 2, 1, 2, 3, '5800.00', '2015-11-06 15:54:43', '2015-11-16 18:00:06'),
...
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 COMMENT='товары заказов';
...
CREATE TABLE IF NOT EXISTS `order_status` (
  ...
  `name` varchar(255) NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 COMMENT='статусы заказов';
...
ALTER TABLE `shop_products`
  ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `opencart_id` (`opencart_id`);
